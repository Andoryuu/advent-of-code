...
fn main() {
    let input = fs::read_to_string("./crates/day09/_data/input.txt").expect("oh noes");
...
fn process_part_1(input: &str) -> String {
    input
        ...
        .filter_map(|(a, b)| a.parse::<usize>().ok().zip(b.parse::<usize>().ok()))
        .tuple_combinations()
